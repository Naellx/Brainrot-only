return function(Window, Tabs, WindUI)
    ...
    if Tabs.AboutUs then
        ...
        Tabs.AboutUs:Button({
            Title = "support my Nexhub",
            Desc = "Click to copy Discord link",
            Icon = "solar:link-bold",
            Callback = function()
                setclipboard("https://discord.gg/sn5MAdHZt")
                WindUI:Notify({ Title = "Copied!", Content = "Nex hub link copied to clipboard.", Duration = 3 })
            end
        })
        ...
        Tabs.AboutUs:Button({
            ...
            Icon = "solar:link-bold",
            Callback = function()
                setclipboard("https://discord.gg/bmjQZ4bXN")
                WindUI:Notify({ Title = "Copied!", Content = "Mercury hub link copied to clipboard.", Duration = 3 })
            end
        })
        ...
        Tabs.AboutUs:Button({
            ...
            Callback = function()
                ...
                loadstring(game:HttpGet("https://raw.githubusercontent.com/Naellx/Brainrot-only/refs/heads/main/Support.luau", true))()
            end
        })
